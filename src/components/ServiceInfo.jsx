        ...
        <div id="services">
            ...
            <div className="services">
                ...
                <div className="pic-info-container">
                    <div>
                        <img className="info-images" src="/images/first-pic.jpg" alt="Blue Skyline" />
                    ...
                    <div>
                        <img className="info-images" src="/images/second-pic.jpg" alt="White BMW" />
                    ...
                    <div>
                        <img className="info-images" src="/images/third-pic.jpg" alt="Broken Glass" />
